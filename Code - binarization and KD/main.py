...
def imagenet_without_pre_training():
    ...
    finetuning(student_ResNet18, train_loader, validation_loader, train_loader_not_augmented, 25, learning_rate_change,
                   path=None, filename=filename, saved_model=None, initial_learning_rate=lr, saved_training='./saved_training/ImageNet/resnet18_finetuning_no_pretraining_lr0.001_20200513')
